...
"""
Live performance test for the Isaac ROS Hawk ESS depth (1 full 3 light ESS) graph.
...
class TestIsaacROSHawkEssDepthGraph(ROS2BenchmarkTest):
    ...
    config = ROS2BenchmarkConfig(
        benchmark_name='Isaac ROS Hawk ESS Depth (1 Full 3 Light ESS) Graph Live Benchmark',
