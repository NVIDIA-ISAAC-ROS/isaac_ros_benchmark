...
"""
Live performance test for the Isaac ROS Hawk ESS depth (1 light throttled ESS) graph.
...
def launch_setup(container_prefix, container_sigterm_timeout):
    ...
    result_load_list.append(IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'node_namespace': TestIsaacROSHawkEssDepthGraph.generate_namespace(),
...
class TestIsaacROSHawkEssDepthGraph(ROS2BenchmarkTest):
    ...
    config = ROS2BenchmarkConfig(
        benchmark_name='Isaac ROS Hawk ESS Depth (1 Light Throttled ESS) Graph Live Benchmark',
