...
"""
Performance test for the Isaac ROS Segformer graph.
...
- Graph under Test:
    ...
    2. TensorRTNode: runs PeopleSemSegformer to detect "person" objects
...
- Models:
    - assets/models/peoplesemsegformer/peoplesemsegformer.onnx
"""
...
MODEL_FILE_NAME = 'peoplesemsegformer/peoplesemsegformer.onnx'
ENGINE_FILE_PATH = '/tmp/peoplesemsegformer.plan'


def launch_setup(container_prefix, container_sigterm_timeout):
    """Generate launch description for Segformer."""
    ...
    encoder_node_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'component_container_name':
                f'{TestIsaacROSSegformerGraph.generate_namespace()}/segformer_container',
            'dnn_image_encoder_namespace': TestIsaacROSSegformerGraph.generate_namespace(),
        }.items(),
    )

    tensorrt_node = ComposableNode(
        name='TensorRTNode',
        namespace=TestIsaacROSSegformerGraph.generate_namespace(),
...
class TestIsaacROSSegformerGraph(ROS2BenchmarkTest):
    """Performance test for the Isaac ROS Segformer graph."""

    # Custom configurations
    config = ROS2BenchmarkConfig(
        benchmark_name='Isaac ROS TensorRT Segformer Graph Benchmark',
    ...
    # Amount of seconds to wait for Segformer to be initialized
    SEGFORMER_WAIT_SEC = 60
    ...
    def pre_benchmark_hook(self):
        ...
        time.sleep(self.SEGFORMER_WAIT_SEC)
