...
def launch_setup(container_prefix, container_sigterm_timeout):
    ...
    encoder_node_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'image_mean': str([0.408, 0.447, 0.47]),
            'image_stddev': str([0.289, 0.274, 0.278]),
            'encoding_desired': 'rgb8',
            'tensor_output_topic': 'tensor_pub',
            'attach_to_shared_component_container': 'True',
            'component_container_name':
                f'{TestIsaacROSCenterPose.generate_namespace()}/centerpose_container',
            'dnn_image_encoder_namespace': TestIsaacROSCenterPose.generate_namespace(),
        }.items(),
    )
