...
"""Performance test for OMPL planners (easy)."""
...
def launch_setup(container_prefix, container_sigterm_timeout):
    ...
    TestPlanner.config.benchmark_name = 'OMPL Pipeline Planners (Easy) Benchmark'
    TestPlanner.planning_pipline = PlanningPipeline.OMPL.value
    TestPlanner.diffiulty_mode = DifficultyMode.EASY.value
