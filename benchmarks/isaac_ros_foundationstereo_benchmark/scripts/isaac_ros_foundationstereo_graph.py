...
"""
Performance test for the Isaac ROS FoundationStereo graph using the high-res (576x960) model.
...
- Models:
    - assets/models/foundationstereo/foundationstereo_576x960.onnx
"""
...
MODEL_FILE_NAME = 'foundationstereo/foundationstereo_576x960.onnx'
ENGINE_FILE_PATH = '/tmp/foundationstereo_576x960.engine'
