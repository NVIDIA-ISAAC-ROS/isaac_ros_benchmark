...
"""
Performance test for the Isaac ROS DisparityNode.
...
def launch_setup(container_prefix, container_sigterm_timeout):
    """Generate launch description for benchmarking Isaac ROS DisparityNode."""
...
def generate_test_description():
    return TestIsaacROSDisparityNode.generate_test_description_with_nsys(launch_setup)


class TestIsaacROSDisparityNode(ROS2BenchmarkTest):
    """Performance test for the Isaac disparity node."""

    # Custom configurations
    config = ROS2BenchmarkConfig(
        benchmark_name='Isaac ROS DisparityNode Benchmark',
