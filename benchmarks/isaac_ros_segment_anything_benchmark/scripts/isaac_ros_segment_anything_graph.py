...
"""
Performance test for the Isaac ROS Segment Anything (SAM) graph.
...
MODEL_FILE_NAME = 'segment_anything/sam.onnx'

TRITON_REPO_PATH = ['/tmp/models/segment_anything']
...
def launch_setup(container_prefix, container_sigterm_timeout):
    """Generate launch description for Isaac ROS Segment Anything (SAM) graph."""
    ...
    pad_node = ComposableNode(
        ...
        remappings=[
            ('image', 'segment_anything/resized_image'),
    ...
    # RTDETR pipeline for preproecssing
...
class TestIsaacROSSegmentAnythingGraph(ROS2BenchmarkTest):
    """Performance test for the Isaac ROS Segment Anything (SAM) graph benchmark."""

    # Custom configurations
    config = ROS2BenchmarkConfig(
        benchmark_name='Isaac ROS Segment Anything (SAM) Graph Benchmark',
