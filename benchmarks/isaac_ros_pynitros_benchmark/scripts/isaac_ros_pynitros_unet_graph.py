...
Compared to U-Net graph benchmark, the DNN image encoder in this graph
is re-implemented with PyTorch, speed up using PyNITROS, and placed into
a seperate process.
...
def launch_setup(container_prefix, container_sigterm_timeout):
    ...
    nitros_image_bridge = ComposableNode(
        name='nitros_image_bridge',
        ...
        remappings=[
            ('ros2_input_image', 'image'),
            ('ros2_output_bridge_image', 'image_bridge')
        ]
    )
    ...
    dnn_image_encoder = Node(name='dnn_image_encoder',
                             ...
                             remappings=[
                                ('pynitros_input_msg', 'image_bridge'),
                                ('pynitros_output_msg', 'tensor_pub_bridge')
                             ],
                             output='screen')

    tensor_list_bridge = ComposableNode(
        name='tensor_list_bridge',
        namespace=TestIsaacROSUNetGraph.generate_namespace(),
        package='isaac_ros_nitros_bridge_ros2',
        plugin='nvidia::isaac_ros::nitros_bridge::TensorListConverterNode',
        remappings=[
            ('ros2_input_bridge_tensor_list', 'tensor_pub_bridge'),
            ('ros2_output_tensor_list', 'tensor_pub')
        ]
    )
