...
"""
Performance test for the Isaac ROS ESS depth (1 full ESS) graph at 30Hz.
...
def launch_setup(container_prefix, container_sigterm_timeout):
    ...
    full_ess_depth_include_1 = IncludeLaunchDescription(
    ...
    return [benchmark_container, full_ess_depth_include_1, load_benchmark_nodes]
...
class TestIsaacROSEssDepthGraph(ROS2BenchmarkTest):
    ...
    config = ROS2BenchmarkConfig(
        benchmark_name='Isaac ROS ESS Depth (1 Full ESS) Graph 30Hz Benchmark',
