...
"""
Performance test for the Isaac ROS ESS depth (1 full + 2 throttled light ESS) graph at 30Hz.
...
class TestIsaacROSEssDepthGraph(ROS2BenchmarkTest):
    ...
    config = ROS2BenchmarkConfig(
        benchmark_name='Isaac ROS ESS Depth (1 Full + 2 Throttled Light ESS) Graph 30Hz Benchmark',
