...
"""
Performance test for ROS 1 Bridge.
...
BRIDGE_CONFIG_PATH = 'src/isaac_ros_nitros_bridge/config/nitros_bridge_reference.yaml'
ROS1_INSTALL_PATH = 'install_isolated/setup.bash'

def launch_setup(container_prefix, container_sigterm_timeout):
    """Generate launch description for benchmarking Isaac ROS NITROS bridge reference."""

    data_loader_node = ComposableNode(
        name='DataLoaderNode',
        namespace=TestROS1BridgeNode.generate_namespace(),
...
def generate_test_description():
    return TestROS1BridgeNode.generate_test_description_with_nsys(launch_setup)


class TestROS1BridgeNode(ROS2BenchmarkTest):
    """Performance test for ROS1 Bridge."""

    # Custom configurations
    config = ROS2BenchmarkConfig(
        benchmark_name='Isaac ROS Nitros Bridge Reference Benchmark',
    ...
    def pre_benchmark_hook(self):
        ...
        ros1_converter_cmd = f'source {ros1_setup_path} \
            ...
            && roslaunch isaac_ros_ros1_forward r2b_forward.launch'
