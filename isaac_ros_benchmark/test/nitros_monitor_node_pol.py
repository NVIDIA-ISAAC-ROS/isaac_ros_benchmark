...
class NitrosMonitorNodeTest(IsaacROSBaseTest):
    ...
    def test_monitor_node_services(self):
        ...
        start_monitoring_client0 = ClientUtility.create_service_client_blocking(
            self.node, StartMonitoring,
            'monitor_node0_start_monitoring', SERVICE_SETUP_TIMEOUT_SEC)
        ...
        start_monitoring_client1 = ClientUtility.create_service_client_blocking(
            self.node, StartMonitoring,
            'monitor_node1_start_monitoring', SERVICE_SETUP_TIMEOUT_SEC)
        ...
        stop_monitoring_client0 = ClientUtility.create_service_client_blocking(
            self.node, StopMonitoring, 'monitor_node0_stop_monitoring', SERVICE_SETUP_TIMEOUT_SEC)
        ...
        stop_monitoring_client1 = ClientUtility.create_service_client_blocking(
            self.node, StopMonitoring, 'monitor_node1_stop_monitoring', SERVICE_SETUP_TIMEOUT_SEC)
        ...
        stop_monitoring_response0 = ClientUtility.get_service_response_from_future_blocking(
            self.node, stop_monitoring_future0, SERVICE_FUTURE_TIMEOUT_SEC)
        self.assertIsNotNone(stop_monitoring_response0)
        self.node.get_logger().info(
            'Received response from the monitor_node0_stop_monitoring service:')
        self.node.get_logger().info(str(stop_monitoring_response0))
        ...
        stop_monitoring_response1 = ClientUtility.get_service_response_from_future_blocking(
            self.node, stop_monitoring_future1, SERVICE_FUTURE_TIMEOUT_SEC)
        self.assertIsNotNone(stop_monitoring_response1)
        self.node.get_logger().info(
            'Received response from the monitor_node1_stop_monitoring service:')
        self.node.get_logger().info(str(stop_monitoring_response1))
